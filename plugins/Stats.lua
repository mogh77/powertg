...
if matches[1]:lower() == 'powerup' then — Put everything you like :)
...
savelog(msg.to.id, name.." ["..msg.from.id.."] used /powerup ")
...
if matches[2] == "powerup" then — Put everything you like :)
